...
const Login_template = create_ssr_component(($$result, $$props, $$bindings, slots) => {
	...
	return `<h1 class="svelte-ull3w5"><span class="wave svelte-ull3w5">👋</span> Here Now</h1> ${each(loginURLs, ({ url, label }) => {
