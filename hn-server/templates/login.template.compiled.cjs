...
const css = {
	code: ".login-btn.svelte-1cu5qvs{text-decoration:none;display:block;padding:16px 12px}.login-btn.svelte-1cu5qvs:hover{background:rgba(128, 128, 138, 0.1)}.note.svelte-1cu5qvs{font-size:0.8rem;color:#666;margin-bottom:16px}",
	map: "{\"version\":3,\"file\":\"login.template.svelte\",\"sources\":[\"login.template.svelte\"],\"sourcesContent\":[\"<script lang=\\\"ts\\\">import Header from \\\"./Header.svelte\\\";\\nimport { LoginURL } from \\\"./templates.ts\\\";\\nexport let note = \\\"Note\\\";\\nexport let loginURLs = [\\n    LoginURL({ label: \\\"Discord\\\", url: \\\"#login-discord\\\" }),\\n    LoginURL({ label: \\\"Slack\\\", url: \\\"#login-slack\\\" }),\\n    LoginURL({ label: \\\"Google Workspace\\\", url: \\\"#login-google-workspace\\\" }),\\n];\\n</script>\\n\\n<Header/>\\n\\n{#if note }\\n  <p class=\\\"note\\\">{note}</p>\\n{/if}\\n\\n{#each loginURLs as { url, label }}\\n  <a href={url} class=\\\"login-btn\\\">{label}</a>\\n{/each}\\n\\n<style>\\n  .login-btn {\\n    text-decoration: none;\\n    display: block;\\n    padding: 16px 12px;\\n  }\\n  .login-btn:hover {\\n    background: rgba(128, 128, 138, 0.1);\\n  }\\n  .note {\\n    font-size: 0.8rem;\\n    color: #666;\\n    margin-bottom: 16px;\\n  }\\n</style>\\n\"],\"names\":[],\"mappings\":\"AAqBE,yBAAW,CACT,eAAe,CAAE,IAAI,CACrB,OAAO,CAAE,KAAK,CACd,OAAO,CAAE,IAAI,CAAC,IAChB,CACA,yBAAU,MAAO,CACf,UAAU,CAAE,KAAK,GAAG,CAAC,CAAC,GAAG,CAAC,CAAC,GAAG,CAAC,CAAC,GAAG,CACrC,CACA,oBAAM,CACJ,SAAS,CAAE,MAAM,CACjB,KAAK,CAAE,IAAI,CACX,aAAa,CAAE,IACjB\"}"
};
...
const Login_template = create_ssr_component(($$result, $$props, $$bindings, slots) => {
	...
	return `${validate_component(Header, "Header").$$render($$result, {}, {}, {})} ${note
	? `<p class="note svelte-1cu5qvs">${escape(note)}</p>`
	: ``} ${each(loginURLs, ({ url, label }) => {
		return `<a${add_attribute("href", url, 0)} class="login-btn svelte-1cu5qvs">${escape(label)}</a>`;
	})}`;
});
