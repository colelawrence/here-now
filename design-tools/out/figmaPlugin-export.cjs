...
function exportForFigma(settings) {
    ...
    const allColorSets = colorSets
        ...
        {
            Name: `${set.Name} Light`,
            Colors: (0, designSystem_cjs_1.getAllColorsKebab)(set.theme, { dark: false }),
        },
        {
            Name: `${set.Name} Dark`,
            Colors: (0, designSystem_cjs_1.getAllColorsKebab)(set.theme, { dark: true }),
        },
    ]);
...
//# sourceMappingURL=figmaPlugin-export.cjs.map