...
function getColorCSSPropertiesForTailwind(colorSettings, options) {
  ...
  return kebab.map((a) => ({
    ...
    valueRGBSpaced: `${(0, material_color_utilities_1.redFromArgb)(a.argb)} ${(0,
    material_color_utilities_1.greenFromArgb)(a.argb)} ${(0, material_color_utilities_1.blueFromArgb)(a.argb)}`,
  }));
}
