...
exports.addItemStateVariants = void 0;
const plugin = require("tailwindcss/plugin");
function addItemStateVariants(options) {
...
exports.addItemStateVariants = addItemStateVariants;
//# sourceMappingURL=tailwind-addItemStateVariants.cjs.map